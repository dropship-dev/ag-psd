...
exports.writePsdBuffer = exports.writePsdUint8Array = exports.writePsd = exports.readPsd = exports.byteArrayToBase64 = exports.imageDataToCanvas = exports.initializeCanvas = void 0;
...
Object.defineProperty(exports, "imageDataToCanvas", { enumerable: true, get: function () { return helpers_1.imageDataToCanvas; } });
__exportStar(require("./psd"), exports);
var base64_js_1 = require("base64-js");
exports.byteArrayToBase64 = base64_js_1.fromByteArray;
function readPsd(buffer, options, handler) {
    return __awaiter(this, void 0, void 0, function () {
        var reader;
        return __generator(this, function (_a) {
            reader = "buffer" in buffer
                ? (0, psdReader_1.createReader)(buffer.buffer, buffer.byteOffset, buffer.byteLength)
                : (0, psdReader_1.createReader)(buffer);
            return [2 /*return*/, (0, psdReader_1.readPsd)(reader, options, handler)];
        });
    });
}
